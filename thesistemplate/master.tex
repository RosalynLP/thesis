...
\caption{A visualisation of the internal structure of the proton. Quarks are bound together by gluons.\label{fig:proton}}
\end{figure}
...
(LHC)~\cite{LHC} at CERN, and there are plans for new colliders such as the Future Circular Collider~\cite{FCC}, International Linear Collider~\cite{ILC} and Compact Linear Collider~\cite{CLIC}. Many of these experiments involve the collision of protons. At a basic level we can think of
...
\caption{The different PDF flavours determined in the latest NNPDF3.1 release \cite{Ball:2017nwa}.\label{fig:pdfs}}
\end{figure}
