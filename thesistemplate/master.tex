...
(LHC) at CERN[future colliders], which predominantly collides protons. At a basic level we can think of
...
highly complicated and inaccessible to the normal perturbative calculations of Quantum Field Theory (Fig. ~\ref{fig:proton}).
...
theoretical predictions. Once constrained, they can then be applied to any process. Any uncertainties in PDF determination will propagate through to future predictions. There are three
