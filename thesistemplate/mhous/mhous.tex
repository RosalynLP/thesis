...
A first check can be done by comparing the diagonal elements, $\sigma_i$ where $\widehat{S}_{ii} = (\sigma_i)^2$, with the shifts $\delta_i$. This tests whether the per-point errors encompass the NLO to NNLO shift.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t!]
  \begin{center}
...
%\begin{figure}[htb!]
    ...
    \caption{\small The diagonal uncertainties  $\sigma_i$ (red)
      ...
      datapoint (black), for the prescriptions. From top to bottom:  5-point
      $\overline{5}$-point, 9-point, 3-point and 7-point (bottom). All values
