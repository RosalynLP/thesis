...
\subsection{New data}
NNPDF4.0 also includes a large number of additional datasets, including many from the 13 TeV run at the LHC. What's more, many of the existing datasets' implementation has been improved~\cite{EmanueleTalk}.
