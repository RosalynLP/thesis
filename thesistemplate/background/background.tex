...
|\mathcal{M}|^2 = 16\ \mathcal{N}_1 \frac{\alpha^2}{q^4} \bigg\{ (-2q^2)W_1(p,q) + \bigg( 4(p \cdot k)^2 - 4 (p \cdot q)(p \cdot k)) \bigg)W_2(p,q) \bigg\}.
\edm
...
\be
W_{\mu\nu} = \sum_q  f_q(\xi) \hat{W}^q_{\mu\nu} \delta(Q^2 - 2\xi p \cdot q)
= \frac{1}{Q^2} \sum_q  f_q(\xi) \hat{W}^q_{\mu\nu} \delta(1 - \frac{2\xi p \cdot q}{Q^2}),
\ee
...
\be 
|\mathcal{M}_{(e \mu)}|^2 = 16\ \mathcal{N}_1 \frac{\alpha^2}{q^4} \bigg( 16 (p \cdot k)^2 + 8 q^2 (p \cdot k) + 2 q^4 \bigg).
\ee
...
\be 
\begin{split}
|\mathcal{\hat{M}}_q|^2 &= 16\ \mathcal{N}_1 \frac{e_q^2 \alpha^2}{q^4} \bigg\{ 4 (2xp \cdot k)^2 + 4 (2 x p\cdot k) q^2 + 2q^4 \bigg\} \\
&= 16\ \mathcal{N}_1 \frac{e_q^2 \alpha^2}{Q^4} \bigg\{ 4 \bigg(\frac{Q^2}{y}\bigg)^2 - 4 \bigg(\frac{Q^2}{y}\bigg) Q^2 + 2Q^4 \bigg\} \\ 
&= 16\ \mathcal{N}_1 e_q^2 \alpha^2 \bigg\{ 2 + 4 \bigg( \frac{1-y}{y^2} \bigg) \bigg\}.
\end{split}
\ee 
