...
\begin{figure}[H]
  \begin{center}
      \includegraphics[width=0.3\linewidth, trim={0 4.0cm 0 1cm}]{nuclear/plots/spiderchi2_1.png}
    \includegraphics[width=0.3\linewidth, trim={0 2.9cm 0 0}]{nuclear/plots/spiderchi2_2.png}
        \includegraphics[width=0.3\linewidth, trim={0 2.9cm 0 0}]{nuclear/plots/spiderchi2_3.png}
      \includegraphics[width=0.3\linewidth, trim={0 1.2cm 0 1cm}]{nuclear/plots/spiderphi_1.png}
